...
public class IMoneyTest {
	...
	public void add2MoneyWithSameCurrency() {
		...
		assertThat(result).as("Check Money Type and result").isExactlyInstanceOf(Money.class)
				.extracting("currency", "amount").containsExactly("EUR", 26.0);
	...
	public void addMoneyBagWithMoneyNotContainingCurrency() {
		...
		assertAll("addMoneyWithMoneyBagNotContainingCurrency", () -> assertTrue(result instanceof MoneyBag),
	...
	public void addMoneyWithEmptyMoneyBagShouldReturnMoney() {
		...
		assertAll("addMoneyWithEmptyMoneyBagShouldReturnMoney", () -> assertTrue(result instanceof Money),
	...
	public void addEmptyMoneyBagWithMoneyShouldReturnMoney() {
		...
		assertAll("addEmptyMoneyBagWithMoneyShouldReturnMoney", () -> assertTrue(result instanceof Money),
				() -> assertEquals("EUR", ((Money) result).getCurrency()),
				() -> assertEquals(12, ((Money) result).getAmount()));
	}
}
